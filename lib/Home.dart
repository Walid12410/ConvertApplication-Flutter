      ...
      appBar: AppBar(
        ...
        actions: [
          Tooltip(
            ...
            child: IconButton(
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context)=>const Speedpage()),
                );
                },
              icon: const Icon(
                Icons.speed,
          ...
          child: ListView(
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                   Navigator.push(context,
                     MaterialPageRoute(builder: (context)=>const Powerpage()));
                },
              ),
              ListTile(
                leading: const Icon(
                ...
                onTap: () {
                    Navigator.push(context,
                    MaterialPageRoute(builder: (context)=>const Temperturepage()));
                },
              ),
              ListTile(
                leading: const Icon(
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(context,
                     MaterialPageRoute(builder: (context)=>const Bytespage()));
                },
              ),
            ],
          ),
